  ...
  ?>
	 ...
	 { 
			...
			if (isset($uid))
			{
				   ...
				   {
					   echo "<a href='http://localhost//c12.2.0/home/php/bookmarkProduct.php?pid={$Product['id']}' class='bookmark'><i class='fas fa-bookmark'></i></a>";
				   }
					else
					{
						echo "<a href='http://localhost//c12.2.0/home/php/bookmarkProduct.php?pid={$Product['id']}' class='bookmark'><i class='far fa-bookmark'></i></a>";
          			}
          ...
          if (isset($uid))
		  {
          	...
          	{
				  echo "<a href='http://localhost//c12.2.0/home/php/like.php?pid={$Product['id']}' class='like'><i class='fas fa-heart'></i></a>";
          	}
			  else 
			{
				  echo "<a href='http://localhost//c12.2.0/home/php/like.php?pid={$Product['id']}' class='like'><i class='far fa-heart'></i></a>";
            }
		  }
        echo "<img src='http://localhost/c12.2.0/home/image/{$Product['url']}'>
        </div>
      </div>
    ...
    {
      header("location:http://localhost/c12.2.0/");
    }
      ?>
    </main>
     <!--پاصفحه -->
